...
public class ClsConexion {
    ...
    private static ClsConexion con;
    ...
    /* 
    Aplicando singleton para que 
    esta clase pueda ser llamada desde otra.
    */
    public synchronized static ClsConexion getClsConexion()
    {
        if(con==null)
        {
            con = new ClsConexion();            
